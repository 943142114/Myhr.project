...
<!--                            </el-for-item>-->
        ...
        <PeopleintegralDialog :dialog="dialog" :formData="formData" @update="getProfile"></PeopleintegralDialog>
    </div>
</template>

<script>
    import PeopleintegralDialog from "../components/PeopleintegralDialog";
    export default {
        name: "BasicList",
        data(){
            return{
        ...
        methods:{
            ...
            handleEdit(index,row){
                ...
                this.formData = {
                    ...
                    major:row.major,
                    school:row.school,
                    employeepoints:row.employeepoints,
                    employeepointsmark:row.employeepointsmark
                }
            },
