<template>
    ...
    <div class="fillcontain ">
        ...
        <ComprehensiveDialog :dialog="dialog" :formData="formData" @update="getProfile"></ComprehensiveDialog>
    </div>
</template>

<script>
    import ComprehensiveDialog from "../components/ComprehensiveDialog";
    export default {
