<template>
    ...
    <div class="fillcontain " >
        ...
        <SetcompetenceDialog :dialog="dialog" :formData="formData" @update="getProfile"></SetcompetenceDialog>
    </div>
</template>
...
<script>
    ...
    import SetcompetenceDialog from "../components/SetcompetenceDialog";
